...
export default function Menucontainer() {
  ...
  return (
    ...
    <div className={togglee ?'fixed top-0 right-0 w-full md:w-[375px] z-[9999] drop-shadwo-md max-h-screen bg-white flex flex-col ease-in duration-300': ' h-full fixed right-[-105%] top-[0] ease-in duration-300 '}>
